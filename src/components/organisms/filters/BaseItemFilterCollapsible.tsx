...
export const BaseItemFilterCollapsible = ({
  isOpen,
  onToggle,
  equipmentTypeFilter,
  ...
  availableSubTypes,
  rangeFieldsProps,
}: BaseItemFilterCollapsiblePropsType): ReactElement => {
    ...
    <>
      ...
      {isOpen && (
        <div className="flex flex-col gap-3">
          ...
          />
          <BaseItemFilterRangeFields {...rangeFieldsProps} />
        </div>
      )}
    </>
  );
