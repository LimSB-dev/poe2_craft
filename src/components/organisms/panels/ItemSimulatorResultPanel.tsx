...
import { ItemSimulatorActionRatioRow } from "@/components/molecules/rows/ItemSimulatorActionRatioRow";
import { ItemSimulatorResultBaseItemCard } from "@/components/molecules/cards/ItemSimulatorResultBaseItemCard";
import { ItemSimulatorResultStatCard } from "@/components/molecules/cards/ItemSimulatorResultStatCard";
    ...
    >
      ...
      {!selectedBaseItem ? (
        ...
        <div className="flex flex-col gap-4">
          <ItemSimulatorResultBaseItemCard selectedBaseItem={selectedBaseItem} />
