...
import { DbModsTable, SiteTopBar } from "@/components/organisms";
...
export type DbItemClassContainerPropsType = {
...
export const DbItemClassContainer = ({
  itemClass,
  statAffinity,
}: DbItemClassContainerPropsType): ReactElement => {
  ...
  return (
    <>
      <header className="flex flex-col gap-2">
        <SiteTopBar pageHeading={workspacePageHeading} />
